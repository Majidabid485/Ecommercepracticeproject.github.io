...
if (isset($_POST['insert_product'])) {
    ...
    or $product_image3=='' ) {
        ...
        //insert query
        $insert_product = "INSERT INTO `products` (product_title,product_description,product_keywords,category_id,brand_id,
        product_image1,product_image2,product_image3,product_price,product_date,product_status) VALUES ('$product_title',
